...
physical parameters (for example the cycle length impacting the fuel discharge
...
capability to measure the uncertainty on output fuel cycle metrics and relative
contributions, it has only been applied to systematic uncertainties per
...
values at each occurrence) and completely systematic uncertainty (shared by all the
