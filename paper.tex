...
This work estimates the impact of the operational parameters uncertainty on a simple
transition (see Figure \ref{fig:cycle}) inspired from the EG23 of the Screening
And Evaluation Group\cite{ES}: a transition from light water reactors fleet
