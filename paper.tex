...
$7\%$ a slowly drops and stabilize around $3\%$.
...
Around the year 70, it is possible to observe the relative uncertainty related
to cycle time being larger than the overall relative uncertainty. This effect is
directly related to the \gls{OFAT} method used to estimate the individual
uncertainty contribution. While allowing a quick access to the individual
contribution, the \gls{OFAT} method does not capture coupling effect between the
