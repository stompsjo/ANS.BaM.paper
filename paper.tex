...
The relative uncertainty of the uranium consumption dedicated to \gls{PWR}
...
enrichment. Nevertheless such conclusions are constrained by the simulation
hypothesis: not considering radioactive decay removes the decay of $^{241}$Pu
during cooling and considering a transition to fast reactors minimizes the
impact of the discharge composition change induced by the cycle length
variations, when reprocessing them to build the next \gls{MOX} fuel batch.
