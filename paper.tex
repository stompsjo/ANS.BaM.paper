...
Hypothesis have been made to design the response of the cascade: no physical
change are made to the different centrifuges: the cut on the machine remains the
same at every stage. 
